...
import 'package:fluttershuttle/screens/MapScreens/trackDriver.dart';
...
class _OrderRequestState extends State<OrderRequest> {
  ...
  getCurrentName() async {
    ...
    databaseMethods.getUsersById(uid).then((result) async {
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          validator: (val) {
                            return val.length >= 3 ? null : 'Invalid location';
                          },
