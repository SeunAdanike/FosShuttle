...
import 'package:fluttershuttle/screens/appScreens/orderRequestScreen.dart';
...
class MapsReceiverState extends State<MapsReceiver> {
  ...
  _getUserCategory() async {
    ...
    final uid = user.uid;
    _databaseMethods.getUsersById(uid).then((result) {
      ...
      body: Padding(
        ...
        child: Stack(
          children: <Widget>[
            ...
            if (userCat != 'Undergraduate' && userCat == null)
              Align(
