...
import 'package:fluttershuttle/screens/MapScreens/userMapScreen.dart';
import 'package:fluttershuttle/screens/appScreens/show_on_map.dart';
  ...
  _signIn() async {
    if (formKey.currentState.validate()) {
      ...
      await authService
        ...
        if (result != null) {
          await locationsdetail.currentLocation().then((locationData) async {
            final FirebaseUser user = await _auth.currentUser();
            final uid = await user.uid;
            userId = uid;
            Map<String, dynamic> userLocationData = {};
            LocationData newLocationData = locationData;
                    ...
                    Container(
                      child: Stack(
                        children: <Widget>[
                          ...
                          // Container(
                          //   padding:
                          //       EdgeInsets.fromLTRB(310.0, 175.0, 0.0, 0.0),
                          //   child: Text('.',
                          //       style: TextStyle(
                          //           fontSize: 80.0,
                          //           fontWeight: FontWeight.bold,
